...
export class LaboralExperienceController {
  ...
  async createLaboralExperience(
    ...
    this.logger.log(
      `CreateLaboralExperience --> ${JSON.stringify(createLaboralExperienceDto)}`,
    );

    const entity = await this.laboralExperienceService.createLaboralExperience(
      user,
  ...
  getAllLaboralExperience(
    @Query() laboralExperiencePageOptionsDto: LaboralExperiencePageOptionsDto,
  ): Promise<PageDto<LaboralExperienceDto>> {
    return this.laboralExperienceService.getAllLaboralExperience(
  ...
  @HttpCode(HttpStatus.OK)
  getEnabledLaboralExperienceByUserId(
    @AuthUser() user: UserDto,
    @UUIDParam('userId') userId: Uuid,
    @Query() laboralExperiencePageOptionsDto: LaboralExperiencePageOptionsDto,
  ): Promise<PageDto<LaboralExperienceDto>> {
    return this.laboralExperienceService.getAllEnabledLaboralExperienceByUserId(
      user,
      userId,
      laboralExperiencePageOptionsDto,
    );
  ...
  @Auth([], { public: true })
  @HttpCode(HttpStatus.OK)
  getEnabledLaboralExperience(
    @AuthUser() user: UserDto,
    @Query() laboralExperiencePageOptionsDto: LaboralExperiencePageOptionsDto,
  ): Promise<PageDto<LaboralExperienceDto>> {
    return this.laboralExperienceService.getAllEnabledLaboralExperience(
      user,
      laboralExperiencePageOptionsDto,
    );
  }
  ...
  async getSingleLaboralExperience(
    ...
    const entity =
      await this.laboralExperienceService.getSingleLaboralExperience(user, id);
  ...
  updateLaboralExperience(
    ...
    this.logger.log(
      `UpdateLaboralExperience --> ${JSON.stringify(updateLaboralExperienceDto)}`,
    );
    return this.laboralExperienceService.updateLaboralExperience(
      id,
      user,
  ...
  @Auth([RoleType.ADMIN])
  @HttpCode(HttpStatus.ACCEPTED)
  activateLaboralExperience(@UUIDParam('id') id: Uuid): Promise<void> {
